...
const Dashboard = () => {
  ...
  const {showBuyModal} = useContext(userContext)
...
useEffect(() => {
  ...
  return (
    ...
    <div className={`w-2/3 bg-white p-4 rounded shadow ${showBuyModal ? 'filter blur-sm opacity-30' : ''} transition-all duration-300`}>
